...
## Full-Stack Developer | AI & LLM Enthusiast | Flutter Developer

Hi, I'm **Sourish Kanna**. I specialize in building robust solutions using **Python (FastAPI, Flask)** and **Flutter**. I have a strong focus on developing AI-driven systems, including multi-agent LLM platforms and NLP models.

- 🔭 **Currently working on:** A **Next Bus** arrival prediction app with a full CI/CD pipeline.
- 🌱 **I’m currently learning:** Advanced **LLM orchestration (Llama 3, Gemini)** and **DevOps** best practices.
- 💼 **Experience:**
  - **App Developer Intern** at CHANGE Networks (Flutter, REST APIs).
  - **AI Intern** at CSRBOX (IBM Watson, Data Analytics).
